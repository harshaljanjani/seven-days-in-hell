...
You may have noticed the weather. H₂S interacts with atmospheric moisture to produce sulfuric acid microdroplets. Expect reduced visibility and increasingly stormy conditions. On Earth, 252 million years ago, a similar mechanism contributed to the Permian-Triassic extinction; volcanic activity drove ocean anoxia, which allowed sulfate-reducing bacteria to flood the atmosphere with hydrogen sulfide. It killed 96 percent of marine life. We are suggesting you take the surface warnings seriously.
